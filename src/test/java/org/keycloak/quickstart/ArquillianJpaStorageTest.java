...
public class ArquillianJpaStorageTest {
  ...
  public void testCreateUserInStorage() {
    ...
    // The MyUserStorageProvider doesn't implement all methods, e.g.
    // searchForUserStream using attributes is missing, therefore we
    // need to use a different interface, in this case using "search" attribute and
    // pagination
